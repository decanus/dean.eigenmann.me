...
In this post we are gonna discuss an often referenced problem in distributed systems known as ["The Byzantine Generals' Problem"](https://lamport.azurewebsites.net/pubs/byz.pdf). We will also have a brief look at the Two Generals' Problem, sometimes refered to as the "Chinese Generals' Problem", which I sometimes see confused with the Byzantine Generals' Problem.
